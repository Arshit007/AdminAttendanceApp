...
public class ShowDeptFieldActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_dept_field);
    intialise();
    toolbar();
    }
    ...
    private void intialise() {
        ...
        uRecyclerView = findViewById(R.id.all_dept_field);
    ...
    private void showDeptField() {
        ...
        database = FirebaseDatabase.getInstance().getReference().child(deptName);
        database.keepSynced(true);

        FirebaseRecyclerOptions<Category> options = new FirebaseRecyclerOptions.Builder<Category>()
                .setQuery(database, Category.class).build();

        adapter = new FirebaseRecyclerAdapter<Category, ShowDeptFieldActivity.UserViewHolder>(options) {


            @Override
            protected void onBindViewHolder(@NonNull final ShowDeptFieldActivity.UserViewHolder holder, int position, @NonNull final Category category) {
                ...
                holder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(getApplicationContext(), ShowDeptSpecActivity.class);
            ...
            @NonNull
            @Override
            public ShowDeptFieldActivity.UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {

                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_single_value, parent, false);

                return new ShowDeptFieldActivity.UserViewHolder(view);
