...
public class StudentSpecActivity extends AppCompatActivity {
    ...
    private void intialise() {
        ...
        uRecyclerView = findViewById(R.id.all_student_spec);
    ...
    private void showDeptField() {
        ...
        database = FirebaseDatabase.getInstance().getReference("StudentManagement").child(deptName).child(deptSpecName);
        database.keepSynced(true);

        FirebaseRecyclerOptions<Category> options = new FirebaseRecyclerOptions.Builder<Category>()
                .setQuery(database, Category.class).build();

        adapter = new FirebaseRecyclerAdapter<Category, StudentSpecActivity.UserViewHolder>(options) {


            @Override
            protected void onBindViewHolder(@NonNull final StudentSpecActivity.UserViewHolder holder, int position, @NonNull final Category category) {
                ...
                holder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(getApplicationContext(),StudentAdmitYearActivity.class);
            ...
            @NonNull
            @Override
            public StudentSpecActivity.UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {

                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_single_value, parent, false);

                return new StudentSpecActivity.UserViewHolder(view);
