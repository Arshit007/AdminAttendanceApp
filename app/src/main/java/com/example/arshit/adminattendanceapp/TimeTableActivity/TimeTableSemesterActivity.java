...
public class TimeTableSemesterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_time_table_semester);
        intialise();
        toolbar();
    ...
    private void intialise() {
        ...
        uRecyclerView = findViewById(R.id.all_time_table_sem_field);
    ...
    private void showDeptField() {
        ...
        database = FirebaseDatabase.getInstance().getReference("Time Table").child(deptName).child(deptField).child(deptSpecName);
        database.keepSynced(true);

        FirebaseRecyclerOptions<Category> options = new FirebaseRecyclerOptions.Builder<Category>()
                .setQuery(database, Category.class).build();

        adapter = new FirebaseRecyclerAdapter<Category, TimeTableSemesterActivity.UserViewHolder>(options) {


            @Override
            protected void onBindViewHolder(@NonNull final TimeTableSemesterActivity.UserViewHolder holder, int position, @NonNull final Category category) {
                ...
                holder.mView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(getApplicationContext(),TimeTableDetail.class);
            ...
            @NonNull
            @Override
            public TimeTableSemesterActivity.UserViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {

                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_single_value, parent, false);

                return new TimeTableSemesterActivity.UserViewHolder(view);
